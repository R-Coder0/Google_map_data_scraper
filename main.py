    ...
    with sync_playwright() as p:
        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            for listing in listings:
                try:
                    # Wait until the element is visible and stable before clicking
                    listing.wait_for(state="visible", timeout=10000)
            ...
            # output
            #########
            safe_filename = sanitize_filename(f"google_maps_data_{search_for}".replace(' ', '_'))
